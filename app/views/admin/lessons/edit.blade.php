...
<div class="span12">
	<div class="well">
 <form class="form-horizontal center" method="POST" action="/admin/lessons/save/{{$lesson->id}}">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="icon"  name="title" value="{{Input::old('title') ? : $lesson->title}}">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="icon"  name="length" value="{{Input::old('length') ? : $lesson->length}}">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="icon"  name="difficulity" value="{{Input::old('difficulity') ? : $lesson->difficulity}}">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="icon"  name="video_script" value="{{Input::old('video_script') ? : $lesson->video_script}}">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input  type="icon" name="icon" value="{{Input::old('icon') ? : $lesson->icon}}">
  ...
  <div class="control-group">
  	...
  	<div class="controls">
  		{{ Form::textarea('body', Input::old('body') ? : $lesson->body, [])}}
