...
<div class="row">
   <div class="col-md-9">
  @if (Sentry::check())
 <video class="sublime"   width="848" height="530" preload="auto" data-autoresize="fit"  data-uid="my-video-1" preload="auto">
  <source src="{{$lesson->video_script}}"/>
</video>
